...
if (LEMONS_WIPE_CLEAN)
	lemons_run_clean (WIPE FILE ${CMAKE_CURRENT_LIST_DIR}/lemons_config.json DIR ${CMAKE_CURRENT_LIST_DIR}/..)
else()
	lemons_run_clean (FILE ${CMAKE_CURRENT_LIST_DIR}/lemons_config.json DIR ${CMAKE_CURRENT_LIST_DIR}/..)
endif()
