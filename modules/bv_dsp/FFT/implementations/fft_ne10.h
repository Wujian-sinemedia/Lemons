...
public:
    ...
    ~FFT() override
    {
        if (config != nullptr) ne10_fft_destroy_r2c_float32 (config);
    ...
    void initFloat() override
    {
        ...
        if (config != nullptr) config = ne10_fft_alloc_r2c_float32 (m_size);
    }
    ...
    void initDouble() override
    {
        ...
        if (workingBuf == nullptr) workingBuf = malloc (m_size * sizeof (double));
    }
                       ...
                       double* BV_R_       phaseOut) override
    {
        ...
        vecops::cartesian_interleaved_to_polar (
            magOut, phaseOut, workingBuf, m_size / 2 + 1);
    }
                       ...
                       float* BV_R_       phaseOut) override
    {
        ...
        vecops::cartesian_interleaved_to_polar (
            magOut, phaseOut, conversionBuf, m_size / 2 + 1);
    }
    ...
    void forwardMagnitude (const float* BV_R_ realIn, float* BV_R_ magOut) override
    {
        ...
        vecops::cartesian_interleaved_to_magnitudes (
            magOut, conversionBuf, m_size / 2 + 1);
    }
                       ...
                       double* BV_R_       realOut) override
    {
        ...
        vecops::polar_to_cartesian_interleaved (
            workingBuf, magIn, phaseIn, m_size / 2 + 1);
                       ...
                       float* BV_R_       realOut) override
    {
        ...
        vecops::polar_to_cartesian_interleaved (
            conversionBuf, magIn, phaseIn, m_size / 2 + 1);
