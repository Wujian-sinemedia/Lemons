...
public:
    ...
    bool isFloatInitialized() override { return m_fplanf != nullptr; }

    bool isDoubleInitialized() override { return m_dplanf != nullptr; }
    ...
    void initFloat() override
    {
        ...
        m_fpacked =
            (fftwf_complex*) fftw_malloc ((m_size / 2 + 1) * sizeof (fftwf_complex));
    ...
    void initDouble() override
    {
        ...
        m_dpacked =
            (fftw_complex*) fftw_malloc ((m_size / 2 + 1) * sizeof (fftw_complex));
