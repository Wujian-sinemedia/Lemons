...
extern int midiPanStringToInt (const String& string);


extern String midiPanIntToString (const int midiPan);


// converts a midi pitch to a string representation, eg note 69 = A4
extern String pitchToString (const int  midiNoteNumber,
...
/*  Returns the pitch class number for a given string.
 ...
 will return -1.
 */
extern int pitchClassFromString (const String& pitchClassName) noexcept;


// converts a pitch class string to an integer representation, eg A4 = note 69
extern int stringToPitch (const String& string);
