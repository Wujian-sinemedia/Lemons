...
public:
    ...
    virtual ~Parameter() override { rap->removeListener (this); }
    ...
    void refreshDefault() { currentDefault.store (getCurrentNormalizedValue()); }
    ...
    virtual float normalize (const float input) const
    {
    ...
    virtual float denormalize (const float input) const
    {
