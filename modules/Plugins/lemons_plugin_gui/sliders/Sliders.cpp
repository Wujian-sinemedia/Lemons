...
FloatSlider::FloatSlider (plugin::FloatParameter& paramToUse, SliderStyle style)
	: SliderBase (paramToUse), plugin::FloatParameter::Listener (paramToUse), param (paramToUse)
{
...
IntSlider::IntSlider (plugin::IntParameter& paramToUse, SliderStyle style)
	: SliderBase (paramToUse), plugin::IntParameter::Listener (paramToUse), param (paramToUse)
{
	Slider::valueFromTextFunction = [&] (const String& text)
	{
		return static_cast<double> (param.getValueForString (text));
