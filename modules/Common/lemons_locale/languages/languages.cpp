...
struct KnownLanguages final
{
	KnownLanguages()
	{
		...
		languages.emplace_back ("Arawak", "", "arw", StringArray { "SR", "VE" });
		...
		languages.emplace_back ("Baluchi", "", "bal", StringArray { "PK", "TM" });
		...
		languages.emplace_back ("English", "en", "eng",
		                        StringArray { "AS", "AI", "AG", "AU", "AZ", "BS", "BH", "BB", "BZ", "BJ", "BM", "BQ", "BW", "IO", "BN", "BI", "CM", "CA", "KY", "CX", "CC", "CO", "CK", "CU", "CW", "DM", "ER", "SZ", "FK", "FJ", "FI", "GM", "GH", "GI", "GD", "GU", "GG", "GW", "GY", "HK", "IN", "ID", "IQ", "IE", "JM", "KE", "KI", "LS", "LR", "MW", "MY", "MV", "MT", "MH", "MU", "FM", "NA", "NR", "NL", "NZ", "NI", "NG", "NU", "NF", "MP", "PK", "PW", "PG", "PH", "PN", "PR", "QA", "RU", "RW", "KN", "LC", "VC", "WS", "SC", "SL", "SG", "SX", "SB", "SO", "ZA", "GS", "SS", "LK", "SD", "SR", "TZ", "TH", "TL", "TK", "TO", "TT", "TC", "TV", "UG", "GB", "US", "VU", "VE", "VG", "VI", "ZM", "ZW" });
		...
		languages.emplace_back ("Carib", "", "car", StringArray { "SR", "VE" });
		...
		languages.emplace_back ("Maithili", "", "mai", StringArray { "NP" });
		...
		languages.emplace_back ("Papiamento", "", "pap", StringArray { "NL" });
		...
		languages.emplace_back ("Romani", "", "rom", StringArray { "NO", "RO", "SE" });
		...
		languages.emplace_back ("Soninke", "", "snk", StringArray { "SN" });
		languages.emplace_back ("Sranan Tongo", "", "srn", StringArray { "SR" });
		languages.emplace_back ("Serer", "", "srr", StringArray { "SN" });
		...
		languages.emplace_back ("Tumbuka", "", "tum", StringArray { "ZM" });
