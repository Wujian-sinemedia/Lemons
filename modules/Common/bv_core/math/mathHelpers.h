...
constexpr int periodInSamples (double samplerate, FreqType freqHz)
{
...
constexpr int msToSamps (double samplerate, msType ms)
{
...
constexpr noteType midiToFreq (noteType midiNote)
{
...
template < typename noteType >
constexpr noteType freqToMidi (noteType freqHz)
{
    if constexpr (std::is_same_v< noteType, int >)
