...
{
    ScopedWaitCursor(): ScopedCursor (juce::MouseCursor::WaitCursor) { }
};
...
/*=========================================================================================*/
    ...
    */
    static inline void drawSamplesToImage (const juce::Image& image, const float* samples, int numSamples, juce::Colour colour, float thickness)
    {
        if (image.isNull())
            return;
