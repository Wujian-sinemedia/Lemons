...
/** Struct representing the state of a Reverb object.
    @see Reverb
 */
struct ReverbParams
{
    /** Creates a default ReverbParams object. */
    ReverbParams() = default;
    
    /** Creates a ReverbParams object with specified values. */
    ReverbParams (float roomSizeToUse, float dampingAmt, float widthToUse, int wetAmt, int duckAmt, float loCutFreq, float hiCutFreq);
...
public:
    ...
    /** Creates a Reverb object from a ReverbParams object. */
    Reverb (ReverbParams params);
    ...
    /** Returns a ReverbParams object representing the state of this reverb. */
    ReverbParams getParams() const;
    
    /** Restores the state of a ReverbParams object. */
    void setParams (ReverbParams params);
