...
public:
    ...
    void pushSamples (const juce::AudioBuffer< SampleType >& inputBuffer,
    ...
    void pushSamples (const SampleType* inputSamples,
                      const int         numSamples,
                      const int         destChannel);


    void popSamples (juce::AudioBuffer< SampleType >& destBuffer,
                     const int                        destChannel,
    ...
    void popSamples (SampleType* output,
                     const int   numSamples,
                     const int   readingChannel);
    ...
    int numStoredSamples (int channel) const
    {
        return storedSamples.getUnchecked (channel);
    }
