#pragma once
 ...
 description:        This juce module provides basic facilities for drawing to a Push 2's display using a regular juce::Component. The original example code from Ableton can be found at: github.com/Ableton/push2-display-with-juce.
