...
private:
    ...
    TextButton bumpPatch { TRANS("Bump patch"), [&](){ this->version.bumpPatch(); this->close(); } };
    TextButton bumpMinor { TRANS("Bump minor"), [&](){ this->version.bumpMinor(); this->close(); } };
    TextButton bumpMajor { TRANS("Bump major"), [&](){ this->version.bumpMajor(); this->close(); } };
};
