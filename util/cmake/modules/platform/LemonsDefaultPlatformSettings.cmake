...
if (APPLE)
	...
	if (WIN32)
		include (
			"${CMAKE_CURRENT_LIST_DIR}/scripts/lemons_windows_settings.cmake")
	else ()
		include (
			"${CMAKE_CURRENT_LIST_DIR}/scripts/lemons_linux_settings.cmake")
...
function (lemons_set_default_macos_options target)
	...
	set_target_properties (
		${target} PROPERTIES XCODE_ATTRIBUTE_ENABLE_HARDENED_RUNTIME YES)
	...
	set_target_properties (
		${target} PROPERTIES XCODE_ATTRIBUTE_MACOSX_DEPLOYMENT_TARGET
							 ${CMAKE_OSX_DEPLOYMENT_TARGET})
	target_compile_options (
		${target} PRIVATE "-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
