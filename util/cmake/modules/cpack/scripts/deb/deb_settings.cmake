...
if (NOT CPACK_DEBIAN_BUILD_DEPENDS)
	...
	if (EXISTS ${depfile_path})
		...
		lemons_get_list_of_deps_to_install (OUTPUT deps_list FILE
											${depfile_path})
		...
		message (
			AUTHOR_WARNING
				"Depsfile not found, please specify CPACK_DEBIAN_BUILD_DEPENDS")
	endif ()
endif ()

# if (NOT CPACK_DEBIAN_PACKAGE_CONFLICTS) set (CPACK_DEBIAN_PACKAGE_CONFLICTS
# ${_package_conflicts}) endif()
