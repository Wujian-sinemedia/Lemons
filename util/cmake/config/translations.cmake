...
if (PYTHON_EXEC AND LEMONS_GENERATE_TRANSLATION_FILES)
	execute_process (COMMAND "${PYTHON_EXEC}" "${_lemons_translation_scripts_dir}/config_shared_translations.py" "${JUCE_SOURCE_DIR}" "${LEMONS_REPO_ROOT}"
    				 COMMAND_ECHO STDOUT
...
function (lemons_generate_translation_files)
    ...
    execute_process (COMMAND "${PYTHON_EXEC}" "${_lemons_translation_scripts_dir}/config_project_translations.py" "${LEMONS_REPO_ROOT}/translations" "${LEMONS_TRANS_FOLDER}/translations"
    				 COMMAND_ECHO STDOUT
    				 WORKING_DIRECTORY "${LEMONS_REPO_ROOT}")
endfunction()
