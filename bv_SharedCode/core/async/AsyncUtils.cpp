...
template void callOnMessageThread (std::function< void (juce::String) >, juce::String);
...
class VoidDelayedBackgroundCaller :     private juce::Thread,
                                        private juce::AsyncUpdater
{
public:
    VoidDelayedBackgroundCaller (std::function< void() > func, int msInFuture)
      : juce::Thread (TRANS ("Function called synchronously on background thread with delay of ") + juce::String (msInFuture)),
...
template<typename ArgumentType>
class DelayedBackgroundCaller :     private juce::Thread,
                                    private juce::AsyncUpdater
{
public:
    DelayedBackgroundCaller (std::function< void (ArgumentType) > func, ArgumentType arg, int msInFuture)
      : juce::Thread (TRANS ("Function called synchronously on background thread with delay of ") + juce::String (msInFuture)),
...
template void callInBackgroundDelayed (std::function< void (juce::String) >, juce::String, int);
