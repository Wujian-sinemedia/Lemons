...
template<typename SampleType>
void AudioFIFO<SampleType>::pushSamples (const juce::AudioBuffer<SampleType>& inputBuffer, const int inputChannel,
...
template<typename SampleType>
void AudioFIFO<SampleType>::popSamples (juce::AudioBuffer<SampleType>& destBuffer, const int destChannel,
