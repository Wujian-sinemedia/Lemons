...
#define _SMOOTHING_ZERO_CHECK(inputGain) std::max(SampleType(bv_MIN_SMOOTHED_GAIN), SampleType (inputGain))
    ...
    public:
        ...
        virtual void renderBlock (juce::AudioBuffer<SampleType>& output) { juce::ignoreUnused (output); }
